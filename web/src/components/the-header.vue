	...
	<a-layout-header class="header">
	  ...
	  >
	    <a-menu-item key="/">
			...
			<a-menu-item key="/admin/user" v-if="user.id">  <!-- :style="user.id? {} : {display: 'none'}" -->
		...
		<a-modal
			...
			@ok="login"
		>
			<a-form :model="loginUser" :lable-col="{ span: 6}" :wrapper-col="{ span: 18 }">
				<a-form-item lable="登录名">
